# -*- coding: utf-8 -*-
"""
Created on Thu Jan 17 11:32:04 2019
Using 16, 17, 18 season data to train, and test with 18 wc data
method:
    league_rank, player, records
score: 
    0.67, 0.62, 0.58, 0.61
@author: Lung
"""
...
plr_X = np.concatenate((b_team_train_rank, plr_b_one_hot, b_team_train_records, r_team_train_rank, plr_r_one_hot, r_team_train_records), axis=1) #player one hot
#player_y
...
X_test = np.concatenate((b_team_test_rank, wc_plr_b_one_hot, b_team_test_records, r_team_test_rank, wc_plr_r_one_hot, r_team_test_records), axis=1) #player one hot
#player_y
