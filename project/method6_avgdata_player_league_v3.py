# -*- coding: utf-8 -*-
"""
Created on Thu Jan 17 16:46:16 2019
...
plr_X = np.concatenate((b_team_train_rank, plr_b_one_hot, r_team_train_rank, plr_r_one_hot), axis=1) #player one hot
#player_y
...
X_test = np.concatenate((b_team_test_rank, wc_plr_b_one_hot, r_team_test_rank, wc_plr_r_one_hot), axis=1) #player one hot
#player_y
